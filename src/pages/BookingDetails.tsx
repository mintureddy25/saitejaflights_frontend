// BookingDetails.jsx
import { getBooking, cancelBooking } from '@/services/api/bookingsApi';
...
const BookingDetails = () => {
  ...
  const handleCancelBooking = async () => {
    ...
    try {
      setCancelling(true);
      await cancelBooking(Number(booking_id));
          ...
          {booking.status?.toLowerCase() !== 'cancelled' && (
            <div className="p-4 bg-gray-50 border-b border-gray-200">
              <button 
                ...
                disabled={cancelling}
                className="flex items-center justify-center bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 transition-colors duration-200 w-full md:w-auto"
              >
                {cancelling ? (
