...
import { PlaneTakeoff, Clock, Calendar, Ticket, AlertTriangle, CheckCircle } from 'lucide-react';
      ...
      <div className="container mt-8 mx-auto px-4 py-8 max-w-5xl">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center">
            <PlaneTakeoff className="w-8 h-8 text-blue-600 mr-3" />
            <h1 className="text-3xl font-bold text-gray-800">Your Bookings</h1>
          </div>
          <p className="text-gray-600 italic">Showing newest first</p>
        </div>
